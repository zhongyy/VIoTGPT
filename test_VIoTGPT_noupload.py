...
def cut_dialogue_history(history_memory, keep_last_n_words=1000):
...
class ConversationBot:
    ...
    def run_text_initial(self):
        Human_prompt = f'\nHuman: You can use one or several tools to finish following tasks, rather than directly imagine.' \
...
if __name__ == '__main__':
    ...
    parser.add_argument('--query_path', type=str, default="", required=True,
                        help='query_path.')
    ...
    for i in range(len_query_file):
        ...
        try:
            ...
            response = "==========Unknown error 2 of VNGPT=========="
            inter_logs = "==========Unknown error 2 of VNGPT=========="
        dict = {
            "id": query,
            "chains": inter_logs,
            "result": response
