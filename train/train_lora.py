...
from train import DataArguments, ModelArguments, TrainingArguments, make_supervised_data_module
...
def train():
    ...
    if model_args.resume_model_checkpoint:
        # Check the available weights and load them
        checkpoint_name = os.path.join(
            model_args.resume_model_checkpoint, "pytorch_model.bin"
        )  # Full checkpoint
        if not os.path.exists(checkpoint_name):
            checkpoint_name = os.path.join(
                model_args.resume_model_checkpoint, "adapter_model.bin"
